"""Custom factories that build and persist domain-model instances for storage tests."""
...
from tests.polyfactory import BindingFactory, ConflictFactory, ExtensionFactory
